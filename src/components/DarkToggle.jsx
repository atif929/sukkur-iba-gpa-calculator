  ...
  return (
    <button onClick={toggle} title={dark ? "Light Mode" : "Dark Mode"}
      style={{
        ...
        border: "none", cursor: "pointer", padding: 0, overflow: "hidden", flexShrink: 0,
      ...
      {!dark && (
        <div style={{ position: "absolute", top: "25%", left: "8%", fontSize: 9, pointerEvents: "none" }}>☁️</div>
      )}
      <div style={{
        ...
        boxShadow: dark ? "0 0 8px rgba(255,255,200,0.6)" : "0 0 10px rgba(255,160,0,0.7)",
      }}>
        {dark ? "" : ""}
      </div>
    </button>
